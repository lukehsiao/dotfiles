...
ubuntu-install-zola:
	curl --proto '=https' --tlsv1.2 -sSLO https://github.com/getzola/zola/releases/download/v0.12.2/zola-v0.12.2-x86_64-unknown-linux-gnu.tar.gz
	tar xf zola-v0.12.2-x86_64-unknown-linux-gnu.tar.gz
	install -m755 zola ~/.cargo/bin
	rm zola-v0.12.2-x86_64-unknown-linux-gnu.tar.gz zola
...
ubuntu-install-eisvogel:
	curl --proto '=https' --tlsv1.2 -sSL https://github.com/Wandmalfarbe/pandoc-latex-template/releases/download/v1.6.1/Eisvogel-1.6.1.tar.gz -o /tmp/eisvogel.tar.gz
