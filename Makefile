...
ubuntu-install-zola:
	curl --proto '=https' --tlsv1.2 -sSLO https://github.com/getzola/zola/releases/download/v0.12.0/zola-v0.12.0-x86_64-unknown-linux-gnu.tar.gz
	tar xf zola-v0.12.0-x86_64-unknown-linux-gnu.tar.gz
	install -m755 zola ~/.cargo/bin
	rm zola-v0.12.0-x86_64-unknown-linux-gnu.tar.gz zola
