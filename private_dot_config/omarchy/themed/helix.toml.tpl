...
# UI — leave editor background transparent so the terminal bg shows through
"ui.background" = { }

"ui.linenr" = { fg = "color8" }
"ui.linenr.selected" = { fg = "foreground" }

# Statusline uses an inverted band: bg-color text on fg-color background.
# Guarantees contrast across both light and dark Omarchy themes (foreground
# and background are always picked to be readable against each other).
